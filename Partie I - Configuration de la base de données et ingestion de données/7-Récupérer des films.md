...
2-Activer la pagination :** Sur un petit jeu de données, vous pouvez récupérer toutes les valeurs du tableau en une seule fois ; mais en général, pour des raisons de performances ou de réseau, vous aurez besoin d'une pagination. Exécutez une requête similaire à la précédente, mais cette fois en demandant une _taille de page de 2_ :
